 ...
 * 
 * A host is a process spawned by the main function in main.c 
 *
 ...
 *
 * In addition, if there is a packet on its incoming link, it checks if
 ...
 * This avoids some nodes doing too much work compared
